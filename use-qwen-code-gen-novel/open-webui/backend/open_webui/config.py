...
##########################################
#
# Novel RAG Configuration
#
##########################################

# Enable/disable novel RAG feature
NOVEL_RAG_ENABLED = PersistentConfig(
    "NOVEL_RAG_ENABLED",
    "novel_rag.enabled",
    os.environ.get("NOVEL_RAG_ENABLED", "false").lower() == "true",
)

# llama.cpp embedding service URL
NOVEL_RAG_EMBEDDING_URL = PersistentConfig(
    "NOVEL_RAG_EMBEDDING_URL",
    "novel_rag.embedding_url",
    os.environ.get("NOVEL_RAG_EMBEDDING_URL", "http://localhost:8081/v1/embeddings"),
)

# Milvus connection settings
NOVEL_RAG_MILVUS_HOST = PersistentConfig(
    "NOVEL_RAG_MILVUS_HOST",
    "novel_rag.milvus.host",
    os.environ.get("NOVEL_RAG_MILVUS_HOST", "localhost"),
)

NOVEL_RAG_MILVUS_PORT = PersistentConfig(
    "NOVEL_RAG_MILVUS_PORT",
    "novel_rag.milvus.port",
    int(os.environ.get("NOVEL_RAG_MILVUS_PORT", "19530")),
)

# Collection name for novel chunks
NOVEL_RAG_COLLECTION_NAME = PersistentConfig(
    "NOVEL_RAG_COLLECTION_NAME",
    "novel_rag.collection_name",
    os.environ.get("NOVEL_RAG_COLLECTION_NAME", "novel_chunks"),
)

# Search parameters
NOVEL_RAG_TOP_K = PersistentConfig(
    "NOVEL_RAG_TOP_K",
    "novel_rag.top_k",
    int(os.environ.get("NOVEL_RAG_TOP_K", "10")),
)

NOVEL_RAG_SCORE_THRESHOLD = PersistentConfig(
    "NOVEL_RAG_SCORE_THRESHOLD",
    "novel_rag.score_threshold",
    float(os.environ.get("NOVEL_RAG_SCORE_THRESHOLD", "0.5")),
)
