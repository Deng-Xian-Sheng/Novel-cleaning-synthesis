...
app.state.config.NOVEL_RAG_ENABLED = NOVEL_RAG_ENABLED
app.state.config.NOVEL_RAG_EMBEDDING_URL = NOVEL_RAG_EMBEDDING_URL
app.state.config.NOVEL_RAG_MILVUS_HOST = NOVEL_RAG_MILVUS_HOST
app.state.config.NOVEL_RAG_MILVUS_PORT = NOVEL_RAG_MILVUS_PORT
app.state.config.NOVEL_RAG_COLLECTION_NAME = NOVEL_RAG_COLLECTION_NAME
app.state.config.NOVEL_RAG_TOP_K = NOVEL_RAG_TOP_K
app.state.config.NOVEL_RAG_SCORE_THRESHOLD = NOVEL_RAG_SCORE_THRESHOLD
